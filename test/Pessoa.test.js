...
describe('Testes da classe Pessoa', () => {
  ...
  it('Deve retornar Verdadeiro se a pessoa for maior de idade (idade >= 17)', () => {
    expect(pessoa.ehMaiorDeIdade(17)).to.be.true;
    expect(pessoa.ehMaiorDeIdade(18)).to.be.true;
  });

  it('Deve retornar Falso se a pessoa for menor de idade (idade < 17)', () => {
    expect(pessoa.ehMaiorDeIdade(16)).to.be.false;
    expect(pessoa.ehMaiorDeIdade(15)).to.be.false;
  });

  it('Deve lançar erro se a idade for inválida', () => {
    expect(() => pessoa.ehMaiorDeIdade('17')).to.throw('A idade deve ser um número válido');  
